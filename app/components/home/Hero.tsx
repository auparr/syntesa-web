  ...
  return (
    ...
    >
      <div className="absolute inset-0">
        ...
        <div
          className="absolute inset-0 bg-gradient-to-r from-apple-blue-500/[0.02] via-transparent to-apple-blue-500/[0.02]
                animate-gradient-x"
        />

        <div
          className="absolute inset-0 bg-gradient-to-t from-transparent via-apple-blue-500/[0.02] to-transparent
                animate-gradient"
        />
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 z-10">
        <div className="relative">
          ...
          <div className="text-center space-y-6 sm:space-y-8 relative">
            ...
            <dl
              className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 pt-12 sm:pt-16
